        ...
        <Card sx={{ position: "relative", mb: 2, backgroundColor: "transparent", overflow: "hidden" }}>
            ...
            <Box sx={{
                ...
                <Box>
                    ...
                    <Typography variant="subtitle2">Hosted by <Link to={`/profiles/username`}
                        style={{ color: 'white', fontWeight: 'bold' }}>Bob
                    </Link>
                    </Typography>
                </Box>
                    ...
                    {isHost ? (
                        <>
                            ...
                            <Button
                                ...
                                disabled={isCancelled}>Manage Event</Button>
                        </>
                    ) : (
                        <Button variant="contained"
                            ...
                            {isGoing ? "Cancel Attandence" : "Join Activity"}
                        </Button>
                    )}
                </Box>
            </Box>
